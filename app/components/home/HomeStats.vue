...
<template>
  <UPageGrid class="">
    <UPageCard v-for="(card, index) in dashboardCard" :key="index" :to="card.to">
      ...
      <UPageLogos>
        <UIcon :name="card.icon" class="size-30 shrink-0" />
      </UPageLogos>
    </UPageCard>
  </UPageGrid>
</template>
