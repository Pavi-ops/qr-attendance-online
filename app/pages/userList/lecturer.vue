  ...
  },
  {
    ...
    cell: ({ row }) =>
      h(UBadge, {
        class: 'capitalize',
        variant: 'subtle',
        color: row.getValue('role') === 'lecturer' ? 'success' : 'neutral'
      }, () => row.getValue('role'))
  },
  {
    id: 'actions',
...
<template>
  <div class="flex-1 divide-y divide-accented w-full">
    ...
    <UTable v-if="data.length" ref="table" :data="data" :columns="columns" sticky class="h-96">
